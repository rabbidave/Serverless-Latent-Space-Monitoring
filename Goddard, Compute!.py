    ...
    Statement = [
      {
        ...
        Resource = [
          ...
          // Assuming S3 bucket and SQS queue ARNs are passed as variables or constructed here
          var.s3_bucket_arn,
...
resource "aws_security_group" "sg" {
  ...
  // Example of more specific rules; adjust according to actual needs
  egress {
    from_port   = 0
    to_port     = 0
    protocol    = "-1"
...
module "lambda_functions" {
  source = "./modules/lambda" // Assuming a local module for Lambda functions
